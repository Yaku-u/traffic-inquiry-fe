<template>
    <div class="menuContainer">
        ...
        <div class="logo">
            <el-switch class="theme-switch" v-model="isDark" :active-action-icon="Moon" :inactive-action-icon="Sunny" @change="toggleDark" />
            <a href="https://github.com/Yaku-u/traffic-inquiry-fe" target="_blank">
                <svg width="29px" height="25px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98 97">
                    <path
